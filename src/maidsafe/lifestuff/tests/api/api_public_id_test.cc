...
//  EXPECT_EQ(kSuccess, test_elements1_.CreatePublicId(new_public_id));
//  EXPECT_NE(kSuccess, test_elements1_.CreatePublicId(new_public_id));
...
//  EXPECT_NE(kSuccess, test_elements2_.CreatePublicId(new_public_id));
//  EXPECT_EQ(kSuccess, DoFullLogOut(test_elements2_));

//  EXPECT_EQ(kSuccess, DoFullLogIn(test_elements1_, keyword_1_, pin_1_, password_1_));
//  int new_instances(0);
//  std::vector<NonEmptyString>::iterator it;
//  std::vector<NonEmptyString> names(test_elements1_.PublicIdsList());
//  for (it = names.begin(); it < names.end(); it++) {
//    if (*it == new_public_id)
//      ++new_instances;
//  }
...
//  EXPECT_EQ(kSuccess, DoFullLogIn(test_elements2_, keyword_2_, pin_2_, password_2_));
//  names = test_elements2_.PublicIdsList();
//  for (it = names.begin(); it < names.end(); it++) {
//    if (*it == new_public_id)
//      ++new_instances;
//  }
...
//  for (size_t i = 0; i < sleep_values.size(); ++i) {
//    boost::thread thread_1([&] {
//                             sleepthreads::RunCreatePublicId(test_elements1_,
//                                                             std::ref(result_1),
//                                                             new_public_id,
//                                                             sleep_values.at(i));
//                           });
//    boost::thread thread_2([&] {
//                             sleepthreads::RunCreatePublicId(test_elements2_,
//                                                             std::ref(result_2),
//                                                             new_public_id,
//                                                             sleep_values.at(i));
//                           });
...
//    file_path1 = test_elements1_.mount_path() / file_name1.string();
...
//    EXPECT_EQ(kSuccess, test_elements1_.SendFile(public_id_1_, public_id_2_, file_path1));
...
//    EXPECT_NE(kSuccess, test_elements2_.AcceptSentFile(NonEmptyString(
//        testing_variables_2_.file_id)));
//    EXPECT_NE(kSuccess, test_elements2_.AcceptSentFile(NonEmptyString(
//        testing_variables_2_.file_id), test_elements2_.mount_path() / file_name2, &file_name2));
//    EXPECT_EQ(kSuccess, test_elements2_.AcceptSentFile(NonEmptyString(
//        testing_variables_2_.file_id), test_elements2_.mount_path() / file_name2));

//    EXPECT_TRUE(fs::exists(test_elements2_.mount_path() / file_name2, error_code));
//    EXPECT_EQ(0, error_code.value());
...
//    EXPECT_EQ(kSuccess, test_elements2_.AcceptSentFile(file_id, fs::path(), &saved_file_name));
//    EXPECT_EQ(file_name1.string(), saved_file_name);
//    fs::path path2(test_elements2_.mount_path() / kMyStuff / kDownloadStuff / saved_file_name);
...
//    fs::path path2a(test_elements2_.mount_path() /
//                      kMyStuff / kDownloadStuff / file_name1.string()),
//             path2b(test_elements2_.mount_path() / kMyStuff / kDownloadStuff / saved_file_name);
...
//    fs::remove_all(test_elements2_.mount_path() / kMyStuff, error_code);
//    EXPECT_EQ(0, error_code.value());
//    EXPECT_FALSE(fs::exists(test_elements2_.mount_path() / kMyStuff, error_code));
...
//    EXPECT_EQ(kSuccess, test_elements2_.ChangeProfilePicture(public_id_2_, file_content2));
...
//    file_content1 = test_elements1_.GetContactProfilePicture(public_id_1_, public_id_2_);
//    EXPECT_TRUE(file_content2 == file_content1);
//    EXPECT_NE(kSuccess, test_elements1_.ChangeProfilePicture(public_id_1_, NonEmptyString(" ")));
...
//    EXPECT_EQ(kSuccess, DoFullLogIn(test_elements2_, keyword_2_, pin_2_, password_2_));
//    // Setting of profile image
//    EXPECT_EQ(kSuccess, test_elements2_.ChangeProfilePicture(public_id_2_, kBlankProfilePicture));
...
//    EXPECT_EQ(kSuccess, test_elements1_.RemoveContact(public_id_1_, public_id_2_,
//                                                       removal_message.string()));
//    EXPECT_TRUE(test_elements1_.GetContacts(public_id_1_).empty());
...
//      contact_deleted = test_elements2_.GetContacts(public_id_2_).empty();
...
//      DoFullLogIn(test_elements1_, keyword_1_, pin_1_, password_1_);
//      test_elements1_.AddContact(public_id_1_, public_id_2_, request_message.string());
//      EXPECT_EQ(kSuccess, DoFullLogOut(test_elements1_));

//      DoFullLogIn(test_elements2_, keyword_2_, pin_2_, password_2_);
//      while (!testing_variables_2_.newly_contacted)
//        Sleep(bptime::milliseconds(100));
//      EXPECT_EQ(testing_variables_2_.contact_request_message, request_message.string());
//      test_elements2_.ConfirmContact(public_id_2_, public_id_1_);
//      EXPECT_EQ(kSuccess, DoFullLogOut(test_elements2_));
//    } else {
//      testing_variables_1_.newly_contacted = false;
//      DoFullLogIn(test_elements2_, keyword_2_, pin_2_, password_2_);
//      test_elements2_.AddContact(public_id_2_, public_id_1_, request_message.string());
//      EXPECT_EQ(kSuccess, DoFullLogOut(test_elements2_));
...
//      test_elements1_.ConfirmContact(public_id_1_, public_id_2_);
//      EXPECT_EQ(kSuccess, DoFullLogOut(test_elements1_));
//    }
//  }
//}
...
//  test_elements1_.CreatePublicId(public_id_3);
//  testing_variables_1_.newly_contacted = false;
//  EXPECT_EQ(kSuccess, DoFullLogOut(test_elements1_));

//  DoFullLogIn(test_elements2_, keyword_2_, pin_2_, password_2_);
//  const NonEmptyString message(RandomAlphaNumericString(RandomUint32() % 90 + 10));
//  test_elements2_.AddContact(public_id_2_, public_id_3, message.string());
//  EXPECT_EQ(kSuccess, DoFullLogOut(test_elements2_));
...
//  test_elements1_.ConfirmContact(public_id_1_, public_id_3);
//  EXPECT_EQ(kSuccess, DoFullLogOut(test_elements1_));
//}
...
//  EXPECT_EQ(kSuccess, test_elements1_.AddContact(public_id_3, public_id_2_, add_message.string()));

//  const NonEmptyString remove_message(RandomAlphaNumericString(RandomUint32() % 90));
//  EXPECT_EQ(kSuccess,
//            test_elements1_.RemoveContact(public_id_3, public_id_2_, remove_message.string()));

//  EXPECT_TRUE(test_elements1_.GetContacts(public_id_3).empty());

//  DoFullLogOut(test_elements1_);
...
//  EXPECT_EQ(1, test_elements2_.GetContacts(public_id_2_).size());

//  DoFullLogOut(test_elements2_);
//}
