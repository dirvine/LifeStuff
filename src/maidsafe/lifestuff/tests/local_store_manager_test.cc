...
//    gp.set_signing_id(session_->passport_->PacketName(
//                          passport::kAnmaid, true));
...
//        (!rsa::CheckSignature(new_gp.data(),
//                               gp_res.signature(),
//                               anmaid_public_key_))) {
...
//         std::bind(&LocalStoreManagerTest::OperationLine,
//                   this,
//                   *it,
//                   *itr,
//                   cbo[thread_num],
