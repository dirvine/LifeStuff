...
//  namespace maidsafe {
//
//  void GenerateContacts(std::vector<kademlia::Contact> *cv) {
//    cv->clear();
...
//                  const std::vector<kademlia::Contact> &cv) {
//    boost::this_thread::sleep(boost::posix_time::seconds(1));
//    cb(rc, cv);
//  }
//
//  void FindNodesSucceed(maidsafe::VoidFuncIntContacts cb) {
//    std::vector<kademlia::Contact> cv;
//    GenerateContacts(&cv);
...
//  /*
//  */
//  void BPCallbackFail(const kademlia::Contact &peer,
...
//  }
//
//  void BPCallbackSucceed(const kademlia::Contact &peer,
//                         maidsafe::CreateBPResponse *response,
//                         google::protobuf::Closure *done) {
...
//  }
//
//  void BPInfoCallbackSucceed(const kademlia::Contact &peer,
...
//  }
//
//  void BPInfoCallbackFailed(const kademlia::Contact &peer,
//                            maidsafe::ModifyBPInfoResponse *response,
//                            google::protobuf::Closure *done) {
//    response->set_result(kNack);
//    response->set_pmid_id(peer.node_id().String());
...
//  }
//
//  void BPAddMsgCallbackSucceed(const kademlia::Contact &peer,
...
//  }
//
//  void BPAddMsgCallbackFailed(const kademlia::Contact &peer,
//                              maidsafe::AddBPMessageResponse *response,
//                              google::protobuf::Closure *done) {
//    response->set_result(kNack);
//    response->set_pmid_id(peer.node_id().String());
...
//  }
//
//  void BPAddPresenceCallbackSucceed(const kademlia::Contact &peer,
...
//  }
//
//  void BPAddPresenceCallbackFailed(const kademlia::Contact &peer,
//                                   maidsafe::AddBPPresenceResponse *response,
//                                   google::protobuf::Closure *done) {
//    response->set_result(kNack);
//    response->set_pmid_id(peer.node_id().String());
...
//   public:
//    GetMsgsHelper() : msgs() {}
//    void BPGetMsgsCallbackSucceed(const kademlia::Contact &peer,
...
//      done->Run();
//    }
//    void BPGetMsgsCallbackFailed(const kademlia::Contact &peer,
//                                 maidsafe::GetBPMessagesResponse *response,
//                                 google::protobuf::Closure *done) {
//      response->set_result(kNack);
//      response->set_pmid_id(peer.node_id().String());
//      done->Run();
//    }
//    void BPGetPresenceCallbackSucceed(const kademlia::Contact &peer,
...
//      done->Run();
//    }
//    void BPGetPresenceCallbackFailed(const kademlia::Contact &peer,
//                                     maidsafe::GetBPPresenceResponse *response,
//                                     google::protobuf::Closure *done) {
//      response->set_result(kNack);
//      response->set_pmid_id(peer.node_id().String());
...
//        kademlia::Contact con(SHA512String(boost::lexical_cast<std::string>(i)),
