...
IF(MSVC)
  IF(CMAKE_CL_64)
    SET(GTEST_LIBPATH_SUFFIX msvc/x64/Release Release)
  ELSE()
    SET(GTEST_LIBPATH_SUFFIX msvc/gtest/Release Release)
  ENDIF()
ELSE()
  SET(GTEST_LIBPATH_SUFFIX lib lib64)
ENDIF()

FIND_LIBRARY(Gtest_LIBRARY_RELEASE NAMES gtest PATHS ${GTEST_LIB_DIR} ${GTEST_ROOT_DIR} PATH_SUFFIXES ${GTEST_LIBPATH_SUFFIX})
IF(MSVC)
  IF(CMAKE_CL_64)
    SET(GTEST_LIBPATH_SUFFIX msvc/x64/Debug Debug)
  ELSE()
    SET(GTEST_LIBPATH_SUFFIX msvc/gtest/Debug Debug)
  ENDIF()
  FIND_LIBRARY(Gtest_LIBRARY_DEBUG NAMES gtest_d PATHS ${GTEST_LIB_DIR} ${GTEST_ROOT_DIR} PATH_SUFFIXES ${GTEST_LIBPATH_SUFFIX})
ENDIF()
