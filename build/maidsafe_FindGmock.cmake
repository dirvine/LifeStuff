...
IF(MSVC)
  SET(GMOCK_LIBPATH_SUFFIX msvc/Release Release)
ELSE()
...
IF(MSVC)
  SET(GMOCK_LIBPATH_SUFFIX msvc/Debug Debug)
  FIND_LIBRARY(Gmock_LIBRARY_DEBUG NAMES gmock_d PATHS ${GMOCK_LIB_DIR} ${GMOCK_ROOT_DIR} PATH_SUFFIXES ${GMOCK_LIBPATH_SUFFIX})
ENDIF()
