...
ENDIF()
FIND_PATH(maidsafe_dht_INCLUDE_DIR maidsafe-dht/maidsafe-dht.h PATHS ${MAIDSAFE_DHT_INC_DIR} ${MAIDSAFE_DHT_ROOT_DIR}/build/Win_MSVC/include ${MAIDSAFE_DHT_ROOT_DIR}/include/maidsafe)
...
FILE(STRINGS ${maidsafe_dht_INCLUDE_DIR}/maidsafe-dht/version.h VERSION_LINE REGEX "MAIDSAFE_DHT_VERSION")
...
>>>>>>> LifeStuffExperimental
SET(CHECK_LIB_DIR_UNIQUE ${DHT_LIBRARY_DIR} ${CRYPTO_LIBRARY_DIR})
...
<<<<<<< HEAD
  SET(CHECK_LIB_DIR_DEBUG_UNIQUE ${DHT_LIBRARY_DIR_DEBUG} ${CRYPTO_LIBRARY_DIR_DEBUG})
=======
...
SET(LIBRARIES_LIST ${MAIDSAFE_DHT_LIBRARY} ${CRYPTOPP_LIBRARY} ${MAIDSAFE_DHT_LIBRARY_DEBUG} ${CRYPTOPP_LIBRARY_DEBUG})
...
<<<<<<< HEAD
SET(MAIDSAFE_DHT_DEPENDENCIES_RELEASE ${CRYPTOPP_LIBRARY})
...
LIST(APPEND MAIDSAFE_DHT_DEPENDENCIES_RELEASE ${Protobuf_LIBRARY_RELEASE} ${Boost_DATE_TIME_LIBRARY_RELEASE} ${Boost_FILESYSTEM_LIBRARY_RELEASE} ${Boost_REGEX_LIBRARY_RELEASE} ${Boost_SYSTEM_LIBRARY_RELEASE} ${Boost_THREAD_LIBRARY_RELEASE} ${Boost_SERIALIZATION_LIBRARY_RELEASE})
>>>>>>> LifeStuffExperimental
IF(MSVC)
  SET(MAIDSAFE_DHT_DEPENDENCIES_DEBUG ${CRYPTOPP_LIBRARY_DEBUG})
